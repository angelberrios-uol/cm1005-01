...
function draw()
{
    ...
    strokeWeight(0);
	fill(255,204,153);
    ellipse(150,240,100,80);
    ellipse(95,280,20,100);
    ellipse(205,280,20,100);
    ellipse(150,310,80,60);
    triangle(150,310,110,400,190,400);
    
	//robot body 2 - delete this code and make your own robot body
    fill(204,102,0);
    ellipse(450,240,100,80);
    ellipse(395,280,20,100);
    ellipse(505,280,20,100);
    ellipse(450,310,80,60);
    triangle(450,310,410,400,490,400);

	//robot body 3 - delete this code and make your own robot body
    fill(51,25,0);
    ellipse(750,240,100,80);
    ellipse(695,280,20,100);
    ellipse(805,280,20,100);
    ellipse(750,310,80,60);
    triangle(750,310,710,400,790,400);
    strokeWeight(2);
    fill(200);
